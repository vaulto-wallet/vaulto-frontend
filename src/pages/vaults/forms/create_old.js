  ...
  render(){
    ...
    return (
      <Form layout="vertical" onSubmit={this.handleSubmit}>
        ...
        <Form.Item label="Asset" name='asset' rules={[{ required: this.isRequired(), message: 'Asset field is required!' }]}>
           <Select disabled={!this.isRequired()}>{ assets_options}</Select>
        </Form.Item>


        <Form.Item label="Parent key" name='parent_key' rules={[{ required: this.isRequired(), message: 'Parent type field is required!' }]}>
